...
Conclusion:
Logistic Regression performed slightly better than KNN for this dataset.
This is likely because Logistic Regression handles categorical variables and
binary classification more efficiently, while KNN can be sensitive to
the number of features and irrelevant data.

Overall, Logistic Regression is preferred for this type of marketing prediction.
""".format(acc_log, acc_knn)